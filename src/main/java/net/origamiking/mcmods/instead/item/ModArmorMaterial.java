...
public enum ModArmorMaterial implements ArmorMaterial {
    //FOOLS_GOLD("fools_gold", 7, new int[]{1, 3, 5, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0f, 0.0f, () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    SAPHIRE("saphire", 33, new int[]{3, 5, 9, 3}, 24, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0f, 0.0f, () -> Ingredient.ofItems(ModItems.SAPHIRE_GEM));
