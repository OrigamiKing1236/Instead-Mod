...
public class InwoodBlocks extends ModBlocks {
    ...
    public static final Block INWOOD_BUTTON = registerBlock("inwood_button", new ButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(4.0f).requiresTool().noCollision(), BlockSetType.WARPED, 20, true));
    ...
    public static final Block INWOOD_FENCE_GATE = registerBlock("inwood_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).strength(4.0f).requiresTool(), WoodType.WARPED));
    public static final Block INWOOD_PLATE = registerBlock("inwood_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).strength(4.0f).requiresTool(), BlockSetType.WARPED));
