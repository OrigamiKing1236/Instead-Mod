...
public enum ModToolMaterial implements ToolMaterial {
    SAPHIRE(MiningLevels.DIAMOND, 1561, 9.0f, 2.5f, 24, () -> Ingredient.ofItems(ModItems.SAPHIRE_GEM));//,
    //MALACHITE(MiningLevels.NETHERITE, 1561, 9.0f, 2.5f, 24, () -> Ingredient.ofItems(ModItems.SAPHIRE_GEM));
