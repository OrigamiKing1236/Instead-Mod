package net.origamiking.mcmods.instead.items.custom;
...
public class LivingEneryStarItem extends FlintAndSteelItem {
public LivingEneryStarItem(Settings settings) {
        super(settings);
    }
